...
public class DrinkJDialog extends javax.swing.JDialog implements DrinkController {
     ...
     */
    public DrinkJDialog(Frame frame, boolean modal) {
        super(frame, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblDrinks.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Drink ID", "Drink Name", "Unit Price", "Discount"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DrinkJDialog(new JFrame(), true).setVisible(true);
            }
        });
    }
    ...
    public void addDrinkToBill() {
        String quantity = XDialog.prompt("Quantity?");
